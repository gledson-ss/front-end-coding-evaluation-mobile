...
export const useContactList = create<contactListProps>((set) => ({
  ...
  setEditingContact: (props: contactProps) =>
    set((state) => ({
      editingContact:
        state.contactList.find((item) => item.id === props.id) || state.editingContact,
    })),
  updateContact: (props: contactProps) =>
    set((state) => ({
